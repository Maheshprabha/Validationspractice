...
public class TestScript extends BaseClass {
	...
	CommonHelpers.SendkeysAction(driver, property.getProperty("loc_name"),"userdemo11@gmail.com");
	CommonHelpers.SendkeysAction(driver, property.getProperty("loc_password"), "12345678");
